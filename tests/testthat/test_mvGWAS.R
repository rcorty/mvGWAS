...
test_that(
  ...
  code = {
    ...
    # proper use
    expect_is(object = mvGWAS$new(phenotype_file = '../../data/test_phenos.RDS',
                                  genotype_directory = '../../data'),
              class = 'mvGWAS')
    ...
    expect_error(object = mvGWAS$new(phenotype_file = '../../data/test_phenos.RDS',
